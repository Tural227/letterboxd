...
class CastsAdapter (val onClick : (Int)-> Unit): BaseAdapter<PersonItem, CreditsProfileBinding>(CreditsProfileBinding::inflate) {
    override fun onBindViewHolder(holder: BaseViewHolder<CreditsProfileBinding>, position: Int) {
        ...
        current?.let {
            ...
            holder.binding.imageView21.setOnClickListener { view->
                onClick(it.personID)
            }
