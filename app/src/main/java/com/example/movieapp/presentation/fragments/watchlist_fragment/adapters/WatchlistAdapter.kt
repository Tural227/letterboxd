package com.example.movieapp.presentation.fragments.watchlist_fragment.adapters
...
class WatchlistAdapter(val onClick :(Int)-> Unit, val onLongClick: (Int,Int)->Unit): BaseAdapter<WatchlistItem,ListItemBinding>(ListItemBinding::inflate) {
